...
pub fn load_polyhedron(conn: &Connection, longname: &str) -> rusqlite::Result<Polyhedron> {
...
pub fn triangulate(poly: &Polyhedron) -> Vec<[u32; 3]> {
...
pub fn cpu_mesh(poly: &Polyhedron) -> CpuMesh {
    ...
    CpuMesh {
        ...
        indices: Indices::U32(triangles.into_iter().flatten().collect()),
        ..Default::default()
    }
}
